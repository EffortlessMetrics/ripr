...
pub(crate) fn read_lsp_message(reader: &mut impl BufRead) -> Result<Option<String>, String> {
...
pub(crate) fn write_lsp_message(writer: &mut impl Write, body: &str) -> Result<(), String> {
