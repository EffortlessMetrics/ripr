...
use crate::output::evidence_record::EvidenceRecord;
...
pub(crate) fn build_evidence_health_report(
    ...
    aggregation::build_evidence_health_report(classified, root, calibration)
}
...
pub(crate) fn render_evidence_health_markdown(report: &EvidenceHealthReport) -> String {
    markdown::render_evidence_health_markdown(report)
}
