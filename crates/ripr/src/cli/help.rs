...
Usage:
  ...
  ripr first-action --pr-guidance target/ripr/review/comments.json --assistant-proof target/ripr/reports/test-oracle-assistant-proof.json [--out target/ripr/reports/first-useful-action.json]
...
const FIRST_ACTION_HELP: &str = r#"Usage: ripr first-action [--pr-guidance PATH] [--assistant-proof PATH] [--ledger PATH] [--baseline-delta PATH] [--receipt PATH] [--gate-decision PATH] [--coverage-frontier PATH] [--editor-context PATH] [--out PATH] [--out-md PATH]

First-action options:
  --root PATH                 Workspace root label. Defaults to current directory.
  --pr-guidance PATH          Optional PR guidance JSON from `ripr review-comments`.
  --assistant-proof PATH      Optional assistant proof JSON from `ripr assistant-loop proof`.
  --ledger PATH               Optional PR evidence ledger JSON from `ripr pr-ledger record`.
  --baseline-delta PATH       Optional baseline debt delta JSON from `ripr baseline diff`.
  --receipt PATH              Optional agent or targeted-test receipt JSON.
  --gate-decision PATH        Optional gate-decision JSON from `ripr gate evaluate`.
  --coverage-frontier PATH    Optional coverage/grip frontier JSON.
  --editor-context PATH       Optional saved-workspace editor evidence context JSON.
...
RIPR artifacts. It selects one next test action or fallback reason, keeps
receipts and policy context visible, and does not rerun hidden analysis, edit
...
mod tests {
    ...
    fn command_specific_help_usage_lines_are_stable() {
        ...
        assert!(FIRST_ACTION_HELP.contains("does not rerun hidden analysis"));
