...
| SARIF and CI policy | RIPR-SPEC-0008 pins the planned SARIF rule IDs, configured severity mapping, suppression visibility, advisory defaults, and opt-in baseline policy modes. | `output-sarif-renderer-v1`. |
