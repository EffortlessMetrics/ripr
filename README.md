...
<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=EffortlessMetrics.ripr"><img src="https://img.shields.io/badge/VS%20Marketplace-4%20installs-0078D4" alt="VS Marketplace installs" /></a>
...
| --- | --- | --- |
| Distribution | `0.6.0` is the prepared release line for the Rust crate, VS Code/Open VSX extension, GitHub Release server assets, generated CI workflow artifacts, and the Rust 1.95 MSRV. `0.5.0` remains the last publicly verified release on crates.io, GitHub Releases, VS Marketplace, and Open VSX until the 0.6.0 publish checklist completes. | Publish 0.6.0 and refresh public install / marketplace verification receipts; then return to post-release maintenance. |
...
| Understand source-of-truth rails | [Repo source-of-truth system](docs/reference/SPEC_SYSTEM.md) |
