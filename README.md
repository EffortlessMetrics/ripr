...
now writes the read-only advisory report, generated CI and VS Code project it
as advisory next-action evidence, and
[First useful action workflow](docs/FIRST_USEFUL_ACTION_WORKFLOW.md) explains
how developers, reviewers, and coding agents read the action, verify static
movement, and return receipts. The default generated workflow remains
advisory.
...
| Read and act on one next action | [First useful action workflow](docs/FIRST_USEFUL_ACTION_WORKFLOW.md) |
