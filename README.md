...
<p align="center">
  ...
  <a href="https://codecov.io/gh/EffortlessMetrics/ripr"><img src="https://codecov.io/gh/EffortlessMetrics/ripr/branch/main/graph/badge.svg" alt="Codecov" /></a>
  <a href="docs/BADGE_POLICY.md"><img src="https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/EffortlessMetrics/ripr/main/badges/ripr-plus.json" alt="ripr+" /></a>
</p>
...
<p align="center">
  <em>Static mutation-exposure analysis for Rust/Cargo workspaces.</em>
</p>

<!-- Public Shields endpoint JSON under badges/ is generated by `cargo xtask badges`; verify with `cargo xtask badges --check`. Public badges are repo-scoped. Diff-scoped artifacts belong in PR summaries and CI uploads. See docs/BADGE_POLICY.md and docs/VERIFICATION.md. -->
