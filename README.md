...
<p align="center">
  ...
  <a href="Cargo.toml"><img src="https://img.shields.io/badge/license-MIT%20OR%20Apache--2.0-blue.svg" alt="License: MIT OR Apache-2.0" /></a>
</p>
...
<!-- Public Shields endpoint JSON under badges/ is generated by `cargo xtask badges`; verify with `cargo xtask badges --check`. Public `ripr+` badge counts unresolved repo-scoped seam-native exposure gaps plus actionable test-efficiency findings under configured policy — inbox-zero, not coverage. Diff-scoped artifacts belong in PR summaries and CI uploads. See [docs/BADGE_POLICY.md](docs/BADGE_POLICY.md), [docs/VERIFICATION.md](docs/VERIFICATION.md), and `deferred/hosted-badge-service` in [docs/DEFERRED.md](docs/DEFERRED.md). -->
