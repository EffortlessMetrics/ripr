...
- Lane 1 value resolution now treats same-test struct literal field
  ...
  literal. Resolution is now scoped to prior lines relative to the owner call,
  so later-line shadows do not erase earlier safe calls while same-line
  ordering, before-call shadows, helper-built structs, fixture-parameter
