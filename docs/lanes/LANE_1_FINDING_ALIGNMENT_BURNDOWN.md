...
| 4 | [#1159](https://github.com/EffortlessMetrics/ripr/issues/1159) | `analysis/top-static-limitation-bucket-burndown` | Pick the top named static limitation bucket from #1140 and repair it with fixture-backed before/after evidence. | current: remaining `activation_value_unresolved` bucket after #1238; this slice targets source-order-scoped same-test struct literal projections |
