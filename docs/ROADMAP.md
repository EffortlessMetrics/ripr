...
artifact content. The next ready Lane 4 slice documents how developers,
reviewers, and coding agents use the first action; editor status projection is
a separate Lane 3 follow-up.
