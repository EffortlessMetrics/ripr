...
| `docs/full-evidence-loop` | ready | Update quickstart and installed-user docs around the real diagnostic-to-receipt loop and state that `ripr init` is optional policy materialization, not activation. |
