...
| `spec/preview-evidence-promotion-packet` | done | RIPR-SPEC-0043 defines preview-language promotion packets with default `allowed_now = false`, explicit required/supplied/missing evidence accounting, advisory generated-CI posture, rollback guidance, and no actual promotion. |
