...
| `operator/verify-receipt-status` | ready | Teach `operator-cockpit` to report missing before/after snapshots, agent verify JSON, agent receipt JSON, movement counts, and next commands that match editor copy commands. |
