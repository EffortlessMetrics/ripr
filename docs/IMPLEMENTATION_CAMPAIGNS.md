...
| `docs/language-adapter-preview-workflow` | ready | Document enabling preview adapters, reading mixed-language reports, interpreting preview labels, the static-limit boundary, generated-CI language grouping, and rollback. |
...
- Continue with `docs/language-adapter-preview-workflow`. Document the
  now-landed preview-language CLI/report/editor/generated-CI path without
