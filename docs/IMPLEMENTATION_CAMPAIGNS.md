...
| `docs/pr-review-front-panel-workflow` | ready | Document how reviewers, maintainers, developers, and coding agents read the PR review front panel, follow repair routes, inspect receipts, and interpret advisory limits. |
...
- Continue with `docs/pr-review-front-panel-workflow`. The report contract,
  fixture corpus, read-only producer, and generated-CI advisory projection are
  now in place; the next slice should document reviewer, maintainer, developer,
  and coding-agent use before dogfood receipts or closeout work.
