...
| `release/editor-agent-readiness-proof` | ready | Absorb the release-surface requirements from #463 by showing installed CLI, packaged VSIX, package dry-run, known limits, and the editor-agent loop without replacing the campaign lane. |
