...
- Campaign 22, First Useful Action, is closed. Its report contract, routing
  corpus, read-only producer, generated CI projection, editor projection,
  workflow guide, and checked dogfood receipts now compress existing evidence
  into one advisory next action without changing analyzer, policy, gate, model,
  mutation, or editor-surface behavior.
...
| `campaign/first-useful-action-closeout` | done | Closed Campaign 22 after schema, fixtures, producer, CI projection, editor projection, docs, and dogfood receipts proved one advisory next action without analyzer, policy, gate, model, mutation, or editor-surface sprawl. The closeout audit is recorded in `docs/handoffs/2026-05-09-campaign-22-closeout.md`. |
...
- No ready work item remains in Campaign 22. Choose the next campaign
  explicitly before opening another product lane.
