...
| `suppressions/v1` | ready | `.ripr/suppressions.toml` loader; reason and owner required, expiry encouraged. Suppressed findings stay visible. Blocker (`badge/ripr-plus-count-v1`) cleared. |
