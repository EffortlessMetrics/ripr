...
- REVIEWED_TREE: `7d592c00142f850cf08d52baa4c04398870d50a2`
...
```json
{
  ...
  "commands": [
    ...
    },
    {
      ...
      "stdout_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
      "stdout_truncated": false,
      "subject_role": "source_parent_trusted_checker_self_health",
      "timeout_bound_ms": 180000
    },
    {
  ...
  "materialization": {
    ...
    "disposable_commit": "a56e572ebe89ac708bb1d7e5755998e45319fae3",
  ...
  "preflight": {
    ...
    "sha256": "293b0b1b441068ba84f780500527743b5a7965e150b307be5850846bd518a631",
    "verified": true
  },
  ...
  "resolution_manifest": {
    ...
    "path_role": "source_checkout_regular_file",
    "sha256": "1a490e51b35173bf39240c20cce44fb316cbe7c1d61ed30df8e4ada6fdb54ea3",
    "verified": true
  },
  "reviewed_tree": "7d592c00142f850cf08d52baa4c04398870d50a2",
  "schema": "ripr.source_promotion_resolved_tree_validation.v1",
  ...
  "tool_version": "0.1.0",
  "trusted_checker": {
    "executable_sha256": "f521ad71bc0e2e54e74988c2fd94f149fbd16e00628b46c2870f40c841a1cd62",
    "selection": "running xtask executable from checkout whose HEAD equals source_parent",
    "source_sha": "ad291d1bc936d00847d9712d2adf9ea56ca19533"
  }
}
```
