...
- The **active manifest** names the currently executing campaign. It
  must not carry closed campaigns; closed manifests move to the archive.
...
the ADR. "What is the agent doing right now?" wants the active manifest.
