...
| [RIPR-SPEC-0144](RIPR-SPEC-0144-bounded-subprocess-adapter-boundary.md) | accepted | Bounded, deny-by-default subprocess adapter classification as the existing side_effect family; literal curl only, with arguments, timeout, captured output, cleanup, and explicit error handling; no process execution or runtime-safety claim |
