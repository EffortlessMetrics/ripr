...
| [RIPR-SPEC-0152](RIPR-SPEC-0152-back-sync-verifier.md) | accepted | Exact ordered-parent K, reviewed tree, current-head guard, and policy/release evidence for read-only source-to-swarm back-sync (#3100) |
| [RIPR-SPEC-0151](RIPR-SPEC-0151-bounded-subprocess-adapter-boundary.md) | accepted | Bounded literal allowlisted subprocess adapters with argument, timeout, captured-output, and cleanup evidence use the existing side_effect probe family; dynamic, shell, and unbounded commands retain strict exposure behavior; closes #1454 |
