...
`ripr` is the repo-scoped seam-native static exposure badge. It reports unresolved headline-eligible exposure gaps under the badge policy.

It is not a runtime mutation result, test adequacy claim, proof of correctness, or coverage badge.
