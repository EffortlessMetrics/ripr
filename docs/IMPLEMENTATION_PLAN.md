...
| Editor Agent Integration (10) | Make the saved-workspace editor loop and the agent CLI loop line up from diagnostic to evidence, packet/brief, focused test, verify, receipt, cockpit, CI, and install proof. | Active: `ci/editor-agent-artifacts`, `docs/full-evidence-loop`, `release/editor-agent-readiness-proof`, and `campaign/editor-agent-integration-closeout`. |
...
`ci/editor-agent-artifacts`. The 0.4 release-surface concerns from #463 are
