...
`cargo xtask recommendation-calibration` now emits the advisory report. The
next ready item is the calibration workflow documentation. Campaign 15 is
