...
RIPR-SPEC-0018 now pins the contract; the next ready item is
`report/pr-evidence-ledger`, while CI projection remains blocked until the
report exists.
