...
| Editor Adoption Assurance (Lane 3 tracker) | Make the closed editor cockpit self-orienting for install/open, server compatibility, workspace-root, first-pr packet, receipt, and fail-closed adoption states. | Proposed: [RIPR-PROP-0012](proposals/RIPR-PROP-0012-editor-adoption-assurance.md), [RIPR-SPEC-0054](specs/RIPR-SPEC-0054-editor-adoption-assurance.md), [ADR-0016](adr/0016-editor-adoption-assurance-is-read-only-diagnosis.md), and [the implementation plan](../plans/editor-adoption-assurance/implementation-plan.md) define the #1245-#1253 burn-down stack. |
