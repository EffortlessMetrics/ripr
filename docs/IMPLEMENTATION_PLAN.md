...
read-only report from explicit artifacts, and generated CI projects it as
advisory summary/artifact content. Editor status projection is the next ready
work item.
