...
| PR Summary Front Panel (22) | Make the generated GitHub job summary a reviewer-grade front panel over PR guidance, assistant proof, gate, baseline, ledger, and coverage/grip artifacts. | Active: `ci/unified-pr-summary-card` is ready; summary fixtures, workflow docs, and closeout are blocked behind the card. |
...
PR Summary Front Panel, with `ci/unified-pr-summary-card` ready to make the
generated GitHub job summary the reviewer-grade first screen over existing PR
guidance, assistant proof, gate, baseline, ledger, and coverage/grip artifacts
without changing analyzer, ranking, gate, editor, provider, mutation,
inline-comment, generated-test, or default CI behavior.
