...
| Editor Adoption Assurance (Lane 3 tracker) | Make first-use editor setup, compatibility, root selection, multi-root, receipt mismatch, and first-pr packet mismatch states safe and legible. | Proposed: [RIPR-PROP-0012](proposals/RIPR-PROP-0012-editor-adoption-assurance.md), [RIPR-SPEC-0054](specs/RIPR-SPEC-0054-editor-adoption-assurance.md), [ADR-0016](adr/0016-editor-adoption-assurance-remains-read-only.md), and [the implementation plan](../plans/editor-adoption-assurance/implementation-plan.md) define the issue-backed Lane 3 adoption-assurance stack. |
