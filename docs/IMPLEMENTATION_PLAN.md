...
summary/artifact content, and VS Code status/Show Status can project an
existing workspace-matched report without adding diagnostics or editor
decorations. The first useful action workflow docs are the next ready work
item.
