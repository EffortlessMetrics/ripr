...
so optional gates can be explicit policy over measured evidence, preserve
advisory defaults, keep acknowledgement paths visible, and use runtime mutation
calibration only as imported confidence evidence. Its next ready item is
