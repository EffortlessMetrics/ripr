...
| Editor Adoption Assurance (Lane 3 tracker) | Make first-use editor setup, compatibility, root selection, multi-root, receipt mismatch, and first-pr packet mismatch states safe and legible. | In progress: [RIPR-PROP-0012](proposals/RIPR-PROP-0012-editor-adoption-assurance.md), [RIPR-SPEC-0054](specs/RIPR-SPEC-0054-editor-adoption-assurance.md), [ADR-0016](adr/0016-editor-adoption-assurance-remains-read-only.md), and [the implementation plan](../plans/editor-adoption-assurance/implementation-plan.md) define the issue-backed Lane 3 adoption-assurance stack. Setup/root diagnosis, fixtures, VS Code smoke, and install-to-first-pr docs are done; external-style dogfood and closeout remain. |
| Actionable Evidence Projection | Make public/user-facing RIPR surfaces count and render unresolved actionable canonical repair work, while preserving seam-native inventory as internal diagnostics. | Proposed: [RIPR-PROP-0013](proposals/RIPR-PROP-0013-actionable-evidence-projection.md), [RIPR-SPEC-0055](specs/RIPR-SPEC-0055-actionable-evidence-projection.md), [ADR-0017](adr/0017-public-surfaces-project-actionable-canonical-gaps.md), and [the implementation plan](../plans/actionable-evidence-projection/implementation-plan.md) define the PR-sequenced stack. |
