...
| Python preview | `preview` | Opt-in CLI/report owner, test, assertion/oracle, and probe evidence | [RIPR-SPEC-0028](../specs/RIPR-SPEC-0028-python-preview-static-facts.md), [ADR 0009](../adr/0009-python-parser-substrate.md), [Campaign 27 tracker](../IMPLEMENTATION_CAMPAIGNS.md#campaign-27-language-adapter-preview), Python owner/test, assertion/oracle, and probe fixture families | Owner, test, assertion/oracle, and syntax-first probe facts are fixture-backed; richer related-test ranking and the full static-limit extraction matrix still need follow-up slices. |
