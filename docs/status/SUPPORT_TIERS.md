...
| Python preview | `preview` | Opt-in CLI/report owner, test, assertion/oracle, probe, and related-test evidence | [RIPR-SPEC-0028](../specs/RIPR-SPEC-0028-python-preview-static-facts.md), [ADR 0009](../adr/0009-python-parser-substrate.md), [Campaign 27 tracker](../IMPLEMENTATION_CAMPAIGNS.md#campaign-27-language-adapter-preview), Python owner/test, assertion/oracle, probe, and related-test fixture families | Owner, test, assertion/oracle, core probe, and conservative related-test facts are fixture-backed; static-limit extraction still needs follow-up slices. |
...
preview + Python:
  useful for opt-in owner, test, assertion, probe, and related-test evidence,
  but static-limit extraction is still catching up.
