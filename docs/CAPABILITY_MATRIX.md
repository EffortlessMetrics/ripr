...
| AST-backed test/oracle extraction | `alpha` | `RIPR-SPEC-0001` | ra_ap_syntax function extraction, parser-backed assertion macro extraction, unwrap/expect smoke-oracle tests, probe-relative OracleKind classification, fixture/golden output stability, flow sink classification tests, exact error metamorphic fixture | `test-efficiency-duplicate-discriminator-v1` | oracle kind recognition rate |
