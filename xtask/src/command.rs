...
impl XtaskCommand {
    pub(crate) fn parse(args: impl IntoIterator<Item = String>) -> Self {
        ...
        match command.as_str() {
            ...
            "rust-first-migration-audit" => Self::RustFirstMigrationAudit,
...
pub(crate) fn command_catalog() -> Vec<CommandCatalogEntry> {
    vec![
        ...
        command_entry(
            "rust-first-migration-audit",
            "report_only",
            "target/ripr/reports/rust-first-migration.{md,json}",
            false,
            "Finds non-Rust workflow and runtime surfaces that should move toward Rust/xtask or remain explicitly retained.",
        ),
        command_entry(
            "check-executable-files",
            "non_mutating_check",
