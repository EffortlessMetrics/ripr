...
pub(crate) fn command_catalog() -> Vec<CommandCatalogEntry> {
    vec![
        ...
        command_entry(
            ...
            false,
            "Finds non-Rust programming files that are not retained by approved runtime or fixture surfaces and should move into Rust/xtask or the ripr core design.",
        ),
        command_entry(
            "fixtures [name]",
            "report_only",
