...
impl XtaskCommand {
    pub(crate) fn parse(args: impl IntoIterator<Item = String>) -> Self {
        ...
        match command.as_str() {
            ...
            "vscode-marketplace-version" => Self::VscodeMarketplaceVersion,
...
pub(crate) fn known_commands() -> Vec<&'static str> {
    vec![
        ...
        "check-doc-roles",
        "vscode-compile",
        "vscode-package [--version <version>]",
        "vscode-test",
        "vscode-test-e2e",
...
pub(crate) fn command_catalog() -> Vec<CommandCatalogEntry> {
    vec![
        ...
        command_entry(
            ...
            "editors/vscode/dist",
            false,
            "Builds VS Code extension package artifacts, optionally using the release version supplied by CI.",
        ),
        command_entry(
            "vscode-test",
            "non_mutating_check",
        ...
        command_entry(
            ...
            "stdout",
            false,
            "Extracts the latest VS Code Marketplace extension version from vsce show JSON on stdin for release workflows.",
        ),
        command_entry(
            "package",
            "non_mutating_check",
