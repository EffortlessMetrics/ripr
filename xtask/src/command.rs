...
pub(crate) fn known_commands() -> Vec<&'static str> {
    vec![
        ...
        "ci-docs-only --base <sha> --expect <docs_only|full>",
        "ci-routed-rust-plan --scheduled-route <route> --base <sha> --pr-head <sha> --subject <sha> --event <event> --trust-class <class>",
        "ci-record-command --id <id> -- <command...>",
        "ci-child-receipt --plan <ids> --job-outcome <outcome> --subject-sha <sha> --subject-tree <tree>",
        "ci-routed-rust-result --planned-route <route> --child-conclusion <state> --receipt-state <state> --planned-subject <sha> --observed-subject <sha> --self-hosted-selection-attempted <bool> --private-runner-secret-requested <bool> --org-runner-query-attempted <bool>",
