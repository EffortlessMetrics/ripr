...
pub(crate) fn known_commands() -> Vec<&'static str> {
    vec![
        ...
        "source-promotion run-admission-workflow <exact identity and locator inputs> --workspace-root <dir> --out <dir>",
        "source-promotion verify-admission-workflow --packet <dir>",
