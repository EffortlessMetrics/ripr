...
impl XtaskCommand {
    pub(crate) fn parse(args: impl IntoIterator<Item = String>) -> Self {
        ...
        match command.as_str() {
            ...
            "ripr-swarm-plan" => Self::RiprSwarmPlan(rest),
...
pub(crate) fn known_commands() -> Vec<&'static str> {
    vec![
        ...
        "ripr-swarm-plan [--actionable-gaps <path>] [--top <n>]",
...
pub(crate) fn command_catalog() -> Vec<CommandCatalogEntry> {
    vec![
        ...
        command_entry(
            ...
            false,
            "Ranks actionable canonical gap packets into swarm-ready and blocked repair-coordination buckets.",
        ),
        command_entry(
            "agent-seam-packets [root]",
            "report_only",
