...
pub(crate) enum XtaskCommand {
    ...
    VscodePublishMarketplace(Vec<String>),
...
impl XtaskCommand {
    pub(crate) fn parse(args: impl IntoIterator<Item = String>) -> Self {
        ...
        match command.as_str() {
            ...
            "vscode-publish-marketplace" => Self::VscodePublishMarketplace(rest),
...
pub(crate) fn known_commands() -> Vec<&'static str> {
    vec![
        ...
        "vscode-publish-marketplace --version <version> --vsix <path>",
...
pub(crate) fn command_catalog() -> Vec<CommandCatalogEntry> {
    vec![
        ...
        command_entry(
            "vscode-publish-marketplace --version <version> --vsix <path>",
            "external_state_mutating",
            "VS Code Marketplace extension listing",
            true,
            "Checks the Marketplace version and publishes the VSIX when the version is not already present.",
        ),
        command_entry(
            "targeted-test-outcome --before <path> --after <path>",
            "report_only",
