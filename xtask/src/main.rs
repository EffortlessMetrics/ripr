...
fn print_help() {
    println!(
        "ripr xtask\n\nUsage:\n  cargo xtask <command>\n\nWorkflow commands:\n  shape                              Format and normalize policy artifacts\n  fix-pr                             Run shape and refresh PR summary report\n  pr-summary                         Write reviewer packet from current diff\n  precommit                          Run fast non-mutating policy guardrails\n  check-pr                           Run review-ready checks and refresh summary\n  ci-fast                            Run fmt/check/test plus policy checks\n  ci-full                            Run check-pr plus package/publish dry-run\n\nFixture and golden commands:\n  fixtures [name]                    Refresh fixture outputs (all or one)\n  goldens check                      Verify fixture expected outputs\n  goldens bless <name> --reason ...  Update expected output for one fixture\n  golden-drift                       Report fixture drift against expected outputs\n\nReporting commands:\n  metrics                            Write repository metrics report\n  test-oracle-report                 Generate test oracle classification report\n  check-test-oracles                 Alias for test-oracle-report\n  test-efficiency-report             Generate test efficiency signal report\n  badge-artifacts                    Build badge artifacts\n  repo-badge-artifacts               Build repository-level badge artifacts\n  repo-seam-inventory                Build seam inventory report\n  repo-exposure-report               Build repository exposure report\n  update-badge-endpoints             Refresh docs badge endpoints\n  check-badge-endpoints              Verify docs badge endpoints are current\n  dogfood                            Run ripr against sample scenarios\n  critic                             Produce structural review notes\n  goals status|next|report           Campaign status and planning helper\n  reports index                      Build report index\n  receipts [check]                   Generate/check validation receipts\n\nPolicy and contract checks:\n  check-static-language              Enforce conservative static-language terms\n  check-no-panic-family              Reject panic!/todo!/unreachable! usage\n  check-allow-attributes             Require documented allow(...) attributes\n  check-local-context                Validate local context policy usage\n  check-file-policy                  Enforce Rust-first file policy\n  check-executable-files             Ensure executable files are allowlisted\n  check-workflows                    Enforce workflow composition policy\n  check-droid-review-config          Validate Droid review config\n  check-spec-format                  Validate spec front matter and schema\n  check-fixture-contracts            Verify fixture contract completeness\n  check-traceability                 Verify spec->tests->code traceability\n  check-spec-ids                     Alias for check-traceability\n  check-behavior-manifest            Alias for check-traceability\n  check-capabilities                 Validate capability matrix contracts\n  check-workspace-shape              Validate package/binary/library shape\n  check-architecture                 Validate architecture boundaries\n  check-public-api                   Validate public API contract\n  check-output-contracts             Validate output schema and format contracts\n  check-doc-index                    Validate docs index entries\n  check-readme-state                 Validate README state snapshots\n  markdown-links                     Validate repository Markdown links\n  check-campaign                     Validate active campaign manifests\n  check-goals                        Alias for check-campaign\n  check-pr-shape                     Validate PR scope/reporting shape\n  check-generated                    Validate generated files are current\n  check-dependencies                 Validate dependency policy\n  check-supply-chain                 Validate supply-chain policy\n  check-process-policy               Validate process policy invariants\n  check-network-policy               Validate network policy invariants\n\nRelease helpers:\n  package                            Run cargo package -p ripr --list\n  publish-dry-run                    Run cargo publish -p ripr --dry-run"
    );
}
