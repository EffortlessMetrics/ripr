...
```json
{
  ...
  "materialization": {
    ...
    "reviewed_tree": "ccccccccccccccccccccccccccccccccccccccccc",
  ...
  "non_claims": [
    ...
    "This receipt proves only the named source-governed repository contracts on one exact reviewed tre.",
