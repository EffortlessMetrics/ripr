...
| --- | --- | --- | --- |
| Boundary gap | `fixtures/boundary_gap` | Equality-boundary discriminator is missing from related tests. | Before/after targeted-test outcome should move the seam when the equality assertion is added. |
...
The current corpus is static-fixture backed. Runtime mutation calibration still
needs small checked-in sample artifacts for these cases:
